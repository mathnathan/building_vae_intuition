...
# Load Data
synthData = np.load("data/single_gaussians_sizes=2.npy")
synthDataLabels = np.load("data/single_gaussians_sizes=2_labels.npy")
        ...
        for epoch in range(training_epochs):
            ...
            for i in range(total_batch):
                ...
                if i%interval == 0:
                    ...
                    axes.hist(x2, bins, alpha=0.5, label='large')
